...
from app.misc import b64pem_to_cose_and_jwk_base64, urlsafe_b64encode_nopad
...
def cborformatter():
    ...
    cose_key, device_public_key_b64jwk = b64pem_to_cose_and_jwk_base64(request.json["device_publickey"])

    import requests
    import json

    url = "https://127.0.0.1:443/v1/signed-mdoc-credentials/mdl"
                ...
                "evidence": [
                    {
                        ...
                        "attestation": {
                            ...
                            "date_of_issuance": "2024-01-01T12:00:00Z",
                            "voucher": {
    ...
    base64_mdoc = response.json().get("credential")
    print(base64_mdoc)
