...
class ConfService:
    ...
    revocation_service_url = os.getenv("SERVICE_URL", "http://192.168.1.8:5000/")+ "token_status_list/take"
    ...
    #Nonce endpoint
    nonce_key = "api_docs/test_tokens/nonce_rsa4096.pem"
    ...
    # Italian mDL validity in days
    mdl_it_validity = 7

    # Italian MDL issuing Authority
    mdl_it_issuing_authority = "Italian Ministry of Transport"
